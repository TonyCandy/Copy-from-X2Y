...
class FileManagerApp:
    def __init__(self, root):
        ...
        self.object_type = tk.StringVar(value="folder")
        ...
        match_frame.grid(row=2, column=1, sticky=tk.W, padx=(0, 30))
        ttk.Radiobutton(match_frame, text="精确匹配带扩展名", variable=self.match_mode, value="exact").pack(side=tk.LEFT, padx=(0, 15))
        ttk.Radiobutton(match_frame, text="前缀匹配", variable=self.match_mode, value="prefix").pack(side=tk.LEFT)
